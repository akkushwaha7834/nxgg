<!-- Banner -->
<section class="inner-banner risk" style="background-image: url(images/kyc-policy.png);">
   <div class="container">
      <div class="row">
         <div class="col-md-6">
      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <ol>
               ...
               <li>
                  If you have any questions please don’t hesitate to contact our customer support: support@nxgmarkets.com
               </li>
            </ol>
            <h4 class="fw-800">
            ...
            <p>
               NXG Markets holds the security of documentation at highest priority, and treats all documents it receives with utmost respect and confidentiality. All files we obtain are fully protected using the highest level possible of encryption at every step of the review process.
            </p>
            <p>
               We thank you for your cooperation in helping us make NXG Markets a safer place to trade.
            </p>
         </div>
      </div>
   </div>
