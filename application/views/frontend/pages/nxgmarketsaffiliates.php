...
<!-- Banner -->
<section class="inner-banner" style="background-image: url(<?php echo base_url()?>images/markets-affiliates.png);">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
	...
	<div class="container nxg-affiliates-two">
		<div class="row g-4">
			<div class="col-md-6">
				...
				<img src="<?php echo base_url()?>images/affiliiate.webp" class="img-fluid" alt="affiliiate">
			</div>
