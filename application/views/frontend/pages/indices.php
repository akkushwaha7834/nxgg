...
<!-- Banner -->
<section class="inner-banner" style="background-image: url(<?php echo base_url()?>images/trading_indices_banner.webp);">
	<div class="container">
		<div class="row">
...
<section class="trading-platform-intro">
   <div class="container">
      <div class="row align-items-center">
         ...
         <div class="col-md-6">
            <lottie-player src="<?php echo base_url()?>images/lottie-json/indices.json" style="width: 100%; height: 450px" background="transparent" speed="1" direction="1" mode="normal" loop="" autoplay=""></lottie-player>
         </div>
      </div>
   </div>
</section>
   ...
   <div class="container">
      <div class="row align-items-center">
         <div class="col-lg-6">
            ...
            <div class="icon-box">
               <div class="icon">
               	<img src="<?php echo base_url()?>images/diverse-range-of-indices.png" class="img-fluid" alt="diverse rangeof indices">
               </div>
         ...
         <div class="col-lg-6  d-lg-block d-none text-center">
            <img src="<?php echo base_url()?>images/why-trade-forex.png" class="img-fluid" width="80%" alt="why-trade-forex alt">
         </div>
      </div>
      <div class="row mt-4">
      	<div class="col-md-12">
