...
<!-- Banner -->
<section class="inner-banner" style="background-image: url(images/about-us.png);">
   <div class="container">
      <div class="row">
...
<section class="powered_by_trading">
   <div class="container">
      <div class="row align-items-center">
         <div class="col-md-6">
            <img src="<?php echo base_url()?>images/about-nxg.png" class="img-fluid" alt="About NXG">
         </div>
         <div class="col-md-6">
            <h2 class="text-primary ">
...
<section class="core-trading-values">
   <div class="container">
      <div class="row">
         ...
         <div class="col-lg-6">
            <img src="images/key-principle-06.png" class="img-fluid" alt="Key Principle">
         </div>
      </div>
   </div>
</section>
   ...
   <div class="container">
      ...
      <div class="row align-items-center">
         ...
         <div class="col-md-6 order-md-2 order-1">
            <lottie-player src="<?php echo base_url()?>images/lottie-json/our-mission.json" style="width: 100%; height: 400px" background="transparent" speed="1" direction="1" mode="normal" loop="" autoplay=""></lottie-player>
         </div>
      </div>
      <div class="row align-items-center">
         <div class="col-md-6 order-md-1 order-2">
            <lottie-player src="<?php echo base_url()?>images/lottie-json/our-vision.json" style="width: 100%; height: 400px" background="transparent" speed="1" direction="1" mode="normal" loop="" autoplay=""></lottie-player>
         </div>
         <div class="col-md-6 order-md-1 order-2">
            <div class="mission-content">
               <h3 class="text-black ">
      ...
      <div class="row mt-5 gy-4 justify-content-center text-center">
         <div class="col-lg-4">
            <div class="main-feature">
               <figure>
                  <img src="<?php echo base_url()?>images/integrity.png" class="img-fluid" alt="Integrity">
               </figure>
         ...
         <div class="col-lg-4 col-md-6">
            <div class="main-feature">
               <figure>
                  <img src="<?php echo base_url()?>images/client-centric-approach.png" class="img-fluid" alt="Client centric approach">
               </figure>
               <div class="feature-content">
                  <h4 class="text-primary ">
         ...
         <div class="col-md-6 col-lg-4">
            <div class="main-feature">
               <figure>
                  <img src="<?php echo base_url()?>images/innovation.png" class="img-fluid" alt="Innovation">
               </figure>
               <div class="feature-content">
                  <h4 class="text-primary ">
                     Innovation
         ...
         <div class="col-md-6 col-lg-4">
            <div class="main-feature">
               <figure>
                  <img src="<?php echo base_url()?>images/knowledge-sharing.png" class="img-fluid" alt="Knowlegde Sharing">
               </figure>
               <h4 class="text-primary ">
                  Knowledge Sharing
               </h4>
         ...
         <div class="col-md-6 col-lg-4">
            <div class="main-feature">
               <figure>
                  <img src="<?php echo base_url()?>images/trust-and-reliability.png" class="img-fluid" alt="Trust And Reliability">
               </figure>
               <h4 class="text-primary ">
