...
<!-- Banner -->
<section class="inner-banner" style="background-image: url(<?php echo base_url()?>images/markets-ibs.png);">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
...
<section class="nxg-affiliates">
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-6">
            <lottie-player src="<?php echo base_url()?>images/lottie-json/affiliate.json" style="width: 100%; height: 400px" background="transparent" speed="1" direction="1" mode="normal" loop="" autoplay=""></lottie-player>
         </div>
		</div>
	</div>
		...
		<div class="row g-4">
			...
			<div class="col-md-6 tc">
				<div class="transparent_commision">
					<img src="<?php echo base_url()?>images/nxgmarkets-ibs.webp" class="img-fluid" alt="nxgmarkets-ibs">
				</div>
			</div>
		</div>
	</div>
