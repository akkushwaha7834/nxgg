...
<!-- Banner -->
<section class="inner-banner" style="background-image: url(<?php echo base_url()?>images/trading-signals.png);">
   <div class="container">
      <div class="row">
...
<section class="signup_for_trading">
   <div class="container">
      <div class="row align-items-center">
         ...
         <div class="col-md-6">
            <lottie-player src="<?php echo base_url()?>images/lottie-json/stock-market-investor.json" style="width: 100%; height: 400px" background="transparent" speed="1" direction="1" mode="normal" loop="" autoplay=""></lottie-player>
         </div>
      </div>
   </div>
</section>
