...
<meta charset="utf-8">
	...
	<!--favicon-->
	<link rel="icon" href="<?php echo base_url();?>admintheme/assets/images/favicon-32x32.png" type="image/png" />
	<!--plugins-->
	<link href="<?php echo base_url();?>admintheme/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
	<link href="<?php echo base_url();?>admintheme/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet" />
	<link href="<?php echo base_url();?>admintheme/assets/plugins/metismenu/css/metisMenu.min.css" rel="stylesheet" />
	<!-- loader-->
	<link href="<?php echo base_url();?>admintheme/assets/css/pace.min.css" rel="stylesheet" />
	<script src="<?php echo base_url();?>admintheme/assets/js/pace.min.js"></script>
	<!-- Bootstrap CSS -->
	<link href="<?php echo base_url();?>admintheme/assets/css/bootstrap.min.css" rel="stylesheet">
	<link href="<?php echo base_url();?>admintheme/assets/css/bootstrap-extended.css" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&display=swap" rel="stylesheet">
	<link href="<?php echo base_url();?>admintheme/assets/css/app.css" rel="stylesheet">
	<link href="<?php echo base_url();?>admintheme/assets/css/icons.css" rel="stylesheet">
	<!-- Theme Style CSS -->
	<link rel="stylesheet" href="<?php echo base_url();?>admintheme/assets/css/dark-theme.css" />
	<link rel="stylesheet" href="<?php echo base_url();?>admintheme/assets/css/semi-dark.css" />
	<link rel="stylesheet" href="<?php echo base_url();?>admintheme/assets/css/header-colors.css" />
